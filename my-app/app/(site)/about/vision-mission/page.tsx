...
function ValueCard({ title, description, icon }: ValueCardData) {
  return (
    <article className="rounded-[16px] border-[1.18px] border-heading bg-panel p-6 shadow-[0_1px_1.5px_rgba(0,0,0,0.04),0_4px_6px_rgba(0,0,0,0.03)]">
      <div className="flex">
      ...
      <h3 className="mt-4 text-right text-[20px] font-bold leading-[30px] text-heading">{title}</h3>
      ...
      <FadeInUp>
        <section className="bg-surface py-12 md:py-20">
          <div className="mx-auto w-full max-w-[1280px] px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col overflow-visible rounded-[24px] bg-surface-alt lg:flex-row">
              <div className="flex flex-1 flex-col justify-center px-6 py-10 text-right sm:px-10 lg:px-14 lg:py-12">
                ...
                <div className="mt-4 max-w-[380px] text-right text-body-1" style={{ fontSize: 22, fontWeight: 700, lineHeight: "37.4px" }}>
                  &quot;{s("vision_text")}&quot;
                </div>
                <div className="my-7 h-px w-full bg-panel-border" />
                <SectionHeading>{s("mission_heading")}</SectionHeading>
                <div className="mt-4 max-w-[564px] text-right text-body-1" style={{ fontSize: 22, fontWeight: 700, lineHeight: "37.4px" }}>
                  {s("mission_text")}
                </div>
              </div>
