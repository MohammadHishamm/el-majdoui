...
export const metadata: Metadata = {
  alternates: { canonical: "/contact/complaints" },
  title: "قناة الشكاوى والمقترحات",
  description:
    "قناة الشكاوى والمقترحات لمؤسسة المجدوعي الخيرية — أرسل مقترحًا أو شكوى أو استفسارًا عامًا.",
};
 ...
 * and issues a tracking id. Reached from /contact, which now carries the general 5-field form.
 */
