...
export default async function GalleryPage() {
  ...
  return (
    <main dir="rtl" className="bg-surface" data-nav-surface="light">
      ...
      <section className="-mt-28 bg-surface pt-40 md:pt-44">
        <div className="mx-auto w-full max-w-[1280px] px-4 sm:px-6 lg:px-8">
          <FadeInUp>
            ...
            <h1 className="mt-4 text-right text-[36px] font-medium leading-[40px] text-heading md:text-[40px]">
              معرض الصور والفيديو
            </h1>
      ...
      {/* Filters + gallery */}
      <section className="bg-surface pb-20 pt-8 md:pb-28" aria-label="معرض الصور والفيديو">
        <div className="mx-auto w-full max-w-[1280px] px-4 sm:px-6 lg:px-8">
