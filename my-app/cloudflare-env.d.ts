/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: f11b2f92583530f71a33ee3cf6dac8f1)
...
interface __BaseEnv_CloudflareEnv {
	...
	WORKER_SELF_REFERENCE: Fetcher /* almajdouie */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUPABASE_SERVICE_ROLE_KEY" | "NEXT_PUBLIC_SUPABASE_ANON_KEY" | "NEXT_PUBLIC_SUPABASE_URL" | "NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY" | "NEXT_PUBLIC_SITE_URL" | "NEXT_PUBLIC_MAPTILER_KEY">> {}
}
