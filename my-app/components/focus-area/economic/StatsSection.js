...
export default function StatsSection() {
  ...
  const label1Text = "مبادرة تمويلية مفعّلة";
  const label1Words = label1Text.split(' ');

  const label2Text = "مستفيد تم تمكينه اقتصادياً";
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      mm.add("(min-width: 768px)", () => {
        ...
        // 4. Count up animation for number 1 (45)
        ...
        // 6. Count up animation for number 2 (2500)
      ...
      mm.add("(max-width: 767px)", () => {
        ...
        // 2. Count up animation for number 1 (45)
        const count1Obj = { val: 0 };
        tl.to(count1Obj, {
          val: 45,
          duration: 1.0,
        ...
        // 4. Count up animation for number 2 (2500)
        const count2Obj = { val: 0 };
        tl.to(count2Obj, {
          val: 2500,
          duration: 1.2,
      ...
      <div className="animate-section-content-s3" style={{ width: '100%' }}>
        <div className={styles.row}>
          ...
          <div className={`${styles.cardsCol} animate-stat-card-col`}>
            ...
            {/* Card 1: 45 مبادرة تمويلية مفعّلة */}
            ...
            {/* Card 2: 2,500 مستفيد تم تمكينه اقتصادياً */}
            <div className={styles.statCard}>
          ...
          <div className={`${styles.imageWrapper} animate-stat-img-wrapper`}>
            <Image
              src="/images/economic/Rectangle 5.png"
              alt="مبنى العلم السعودي"
              fill
