...
export default function MosquesIntroSection() {
  const containerRef = useRef(null);

  const text = "تولي المؤسسة عناية فائقة بمساجد المجدوعي؛ ليس فقط من خلال هندستها المعمارية وصيانتها المستدامة لتهيئتها لقاصديها، بل بتمكينها لتكون منارات علمية، شرعية، واجتماعية تقدم قيمة مضافة للمجتمع المحيط بها.";
  ...
  return (
    ...
    >
      <div className={styles.section}>
        ...
        <h2 className={`${styles.heading} animate-title`}>مساجد المجدوعي</h2>
