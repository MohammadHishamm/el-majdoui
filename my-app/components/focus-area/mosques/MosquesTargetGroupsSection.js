...
const slides = [
  {
    id: 1,
    text: 'عمارة وتشييد المساجد',
    rightImage: `${DIR}/corousel-1.png`,
    leftImage: `${DIR}/corousel-1.2.jpg`,
  },
  {
    id: 2,
    text: 'التشغيل والصيانة المستدامة',
    rightImage: `${DIR}/corousel-2.jpg`,
    leftImage: `${DIR}/corousel-2.1.png`,
  },
  {
    id: 3,
    text: 'المنارات العلمية والدعوية',
    rightImage: `${DIR}/corousel-3.png`,
    leftImage: `${DIR}/corousel-3.1.png`,
  },
  {
    id: 4,
    text: 'المبادرات المجتمعية المحيطة',
    rightImage: `${DIR}/corousel-4.png`,
    leftImage: `${DIR}/corousel-4.1.png`,
  },
];

const ARROW = `${DIR}/arrow-of-corousel.svg`;
...
export default function MosquesTargetGroupsSection() {
